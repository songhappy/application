 ...
 */
// scalastyle:off
package com.intel.analytics.bigdl.apps.lenet
...
// scalastyle:off
class LenetTrainSuite extends FunSuite{
  ...
  test("lenet test"){
    ...
    val param = TrainParams(folder = "/Users/guoqiong/intelWork/projects/wrapup/MNIST_data",
      batchSize = 24,
      checkpoint = Some("/Users/guoqiong/intelWork/projects/wrapup/model"))
