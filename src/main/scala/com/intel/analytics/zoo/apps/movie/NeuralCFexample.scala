...
object NeuralCFexample {
  ...
  def run(param: NeuralCFParams): Unit = {
    ...
    val learningRateDecys = List(1e-6, 1e-5)
    val batchSizes = List(4096, 16384, 65536)
  ...
  //  println(s"Root-mean-square error = $rmse")
   ...
   val outString = learningRate + "," + learningRateDecay + "," + batchSize + "," + hidenlayers.mkString("|") + "," + nEpochs + "," + accuracy + "," + rmse
    println("Single: " + outString)
    outString
  }
