...
package com.intel.analytics.models.rnn
...
object Utils {
  ...
  case class TrainParams(
                          dataFolder: String = "/Users/guoqiong/intelWork/projects/wrapup/rnn/inputdata",
                          saveFolder: String = "/Users/guoqiong/intelWork/projects/wrapup/rnn/saveDict",
 ...
 def readSentence(directory: String)
  : Array[Array[String]] = {
...
def fileToWordIdx(fileName: String, dictionary: Dictionary)
  : Iterator[Float] = {
    val words = readWords(fileName)
    words.map(x => dictionary.getIndex(x).toFloat + 1.0f)
  }

def readWords(fileName: String): Iterator[String] = {
...
def load(fileName: String): Array[String] = {
    import scala.io.Source
